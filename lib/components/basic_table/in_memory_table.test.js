...
describe('EuiInMemoryTable', function () {
  test('empty array', function () {
    ...
    var component = (0, _enzyme.shallow)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props));
  ...
  test('with items and expanded item', function () {
    var props = _objectSpread({}, _test.requiredProps, {
      ...
      itemIdToExpandedRowMap: {
        '1': _react.default.createElement("div", null, "expanded row content")
      }
    });
  ...
  describe('sorting', function () {
    test('with field sorting (off by default)', function () {
      ...
      var component = (0, _enzyme.mount)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props));
    ...
    test('with field sorting (on by default)', function () {
      var props = _objectSpread({}, _test.requiredProps, {
        ...
        sorting: {
          sort: {
            field: 'name',
            direction: _services.SortDirection.ASC
          }
        }
      });
    ...
    test('with name sorting', function () {
      var props = _objectSpread({}, _test.requiredProps, {
        ...
        sorting: {
          sort: {
            field: 'Name',
            direction: _services.SortDirection.DESC
          }
        }
      });
    ...
    test('verify field sorting precedes name sorting', function () {
      ...
      var component = (0, _enzyme.mount)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props)); // name TDs should be sorted desc, id TDs should be asc,
    ...
    test('verify an invalid sort field does not blow everything up', function () {
      ...
      expect(function () {
        (0, _enzyme.mount)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props));
      }).not.toThrow();
    });
  });
  ...
  describe('search interaction & functionality', function () {
    it('updates the results as based on the entered query', function () {
      ...
      var component = (0, _enzyme.mount)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props)); // should render with all three results visible
    ...
    it('passes down the executeQueryOptions properly', function () {
      ...
      var noDefaultFieldsComponent = (0, _enzyme.mount)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props)); // should render with the no items found text
      ...
      var defaultFieldComponent = (0, _enzyme.mount)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props2));
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              props = _objectSpread({}, _test.requiredProps, {
                items: [{
                  id: '1',
                  name: 'name1'
                }, {
              ...
              component = (0, _enzyme.mount)(_react.default.createElement(_in_memory_table.EuiInMemoryTable, props));
