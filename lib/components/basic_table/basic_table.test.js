...
describe('getItemId', function () {
  it('returns undefined if no itemId prop is given', function () {
    expect((0, _basic_table.getItemId)({
      id: 5
    })).toBeUndefined();
    expect((0, _basic_table.getItemId)({
      itemId: 5
...
describe('EuiBasicTable', function () {
  describe('empty', function () {
    test('is rendered', function () {
      ...
      var component = (0, _enzyme.shallow)(_react.default.createElement(_basic_table.EuiBasicTable, props));
    ...
    test('renders a node as a custom message', function () {
      var props = {
        ...
        noItemsMessage: _react.default.createElement("p", null, "no items, click ", _react.default.createElement("a", {
          href: ""
        }, "here"), " to make some")
      };
      var component = (0, _enzyme.shallow)(_react.default.createElement(_basic_table.EuiBasicTable, props));
  ...
  test('itemIdToExpandedRowMap renders an expanded row', function () {
    var props = {
      ...
      itemIdToExpandedRowMap: {
        '1': _react.default.createElement("div", null, "Expanded row")
      },
    ...
    test('render with pagination, selection, sorting, and footer', function () {
      var props = {
        ...
        columns: [{
          ...
          description: 'your name',
          sortable: true,
          footer: _react.default.createElement("strong", null, "Name")
        }, {
          field: 'id',
          name: 'ID',
          description: 'your id',
          ...
          footer: function footer(_ref3) {
            ...
            return _react.default.createElement("strong", null, "sum:", items.reduce(function (acc, cur) {
              return acc + cur.age;
            }, 0), _react.default.createElement("br", null), "total items:", pagination.totalItemCount);
          }
        }],
        pagination: {
          pageIndex: 0,
