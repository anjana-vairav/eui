...
import _startCase from 'lodash/startCase'; // @ts-ignore-next-line
...
function (_PureComponent) {
  ...
  _createClass(EuiIcon, [{
    ...
    value: function render() {
      ...
      var icon = this.state.icon || empty; // If it's a named icon, by default the title will be the name
      // If it's a custom icon, it gets an empty alt

      var iconTitle = _startCase(this.state.iconTitle) || '';
