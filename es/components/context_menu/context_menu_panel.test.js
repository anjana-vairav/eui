...
var items = [React.createElement(EuiContextMenuItem, {
  key: "A",
  "data-test-subj": "itemA"
}, "Option A"), React.createElement(EuiContextMenuItem, {
  key: "B",
  "data-test-subj": "itemB"
}, "Option B"), React.createElement(EuiContextMenuItem, {
  key: "C",
  "data-test-subj": "itemC"
}, "Option C")];
describe('EuiContextMenuPanel', function () {
  test('is rendered', function () {
    var component = render(React.createElement(EuiContextMenuPanel, requiredProps, "Hello"));
    expect(component).toMatchSnapshot();
  });
  describe('props', function () {
    describe('title', function () {
      test('is rendered', function () {
        var component = render(React.createElement(EuiContextMenuPanel, {
          title: "Title"
        }));
        expect(component).toMatchSnapshot();
      });
    ...
    describe('onClose', function () {
      ...
      test("isn't called upon instantiation", function () {
        ...
        mount(React.createElement(EuiContextMenuPanel, {
          title: "Title",
      ...
      test('is called when the title is clicked', function () {
        var onCloseHandler = jest.fn();
        var component = mount(React.createElement(EuiContextMenuPanel, {
          title: "Title",
          onClose: onCloseHandler
        }));
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                component = mount(React.createElement(EuiContextMenuPanel, {
                  items: items,
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                component = mount(React.createElement(EuiContextMenuPanel, null, React.createElement("button", {
  ...
  describe('updating items and content', function () {
    describe('updates to items', function () {
      ...
      it('should re-render at all times when children exists', function () {
        ...
        var component = mount(React.createElement(EuiContextMenuPanel, null, "Hello World"));
        expect(component.debug()).toMatchSnapshot();
        component.setProps({
